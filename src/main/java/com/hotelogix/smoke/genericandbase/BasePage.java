...
public class BasePage
{
	...
	public static WebElement Discounts;
    
    @FindBy(xpath="//a[text()='Special Discounts']")
    public static WebElement spclDiscounts;
    
    @FindBy(xpath="//a[text()='Identification Types']")
    public static WebElement identificationType;
...
//xpath for Room Types
		...
		//Navigate to Rooms Page
               ...
               public Discounts_SpecialDiscountLP fn_navigateSpclDiscount() throws Exception
               {
            	   try
            	   {
            		   PageFactory.initElements(GenericMethods.driver, BasePage.class);
            	   GenericMethods.mouseOverElement(General);
            	   GenericMethods.mouseOverElement(Discounts);
            	   GenericMethods.clickElement(spclDiscounts);
            	   
            	   Discounts_SpecialDiscountLP SPD=PageFactory.initElements(GenericMethods.driver, Discounts_SpecialDiscountLP.class);
            	   return SPD;
            	   }
            	   catch(Exception e)
            	   {
               ...
               public IdentificationTypesList fn_navigateIdentiTypes() throws Exception
               {
            	   try
            	   {
            	   GenericMethods.mouseOverElement(General);
            	   GenericMethods.clickElement(identificationType);
            	   
            	   IdentificationTypesList IT=PageFactory.initElements(GenericMethods.driver, IdentificationTypesList.class);
            	   return IT;
            	   }
            	   catch(Exception e)
            	   {
